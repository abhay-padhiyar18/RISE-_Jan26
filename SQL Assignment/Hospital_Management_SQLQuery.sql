...
--Objective
--Design and query a Hospital Management database using DDL, Constraints, DML, DQL, Group By, 
--Subqueries, Update, Delete, and Alter in MSSQL Server.
...
CREATE TABLE Doctors (DoctorID INT, Email VARCHAR(30), DepartmentID INT, Experience INT)

CREATE TABLE Departments (DepartmentID INT, DepartmentName VARCHAR(25))

CREATE TABLE Rooms (RoomID INT, RoomType VARCHAR(25), ChargesPerDay MONEY)
...
-- Section 2 — Apply Constraints (ALTER TABLE)
...
(1,'General',1500),(2,'General',1500),
(3,'General',1500),(4,'Private',3500),
(5,'Private',3500),(6,'Private',3500),
(7,'ICU',7000),(8,'ICU',7000),
(9,'ICU',7000),(10,'General',1500),
(11,'Private',3500),(12,'ICU',7000),
(13,'General',1500),(14,'Private',3500),
(15,'ICU',7000);
